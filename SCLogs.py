...
def get_logs( session, no_of_logs, date=None ):
...
def define_vars():
    ...
    if args.number_of_logs:
        no_of_logs = args.number_of_logs
    ...
    return interactive( date, no_of_logs=no_of_logs, file_name=file_name, host=host )


# uses an interactive interface to get the parameters in rather than the flags/defaults
def interactive(date, host="",no_of_logs="",file_name="" ):
    valid = False
    ...
    return no_of_logs, file_name, host, date
...
if __name__ == "__main__":
    ...
    # get params
    no_of_logs, output_file, host, date = define_vars()
    ...
    r = get_logs( session, no_of_logs, date )
